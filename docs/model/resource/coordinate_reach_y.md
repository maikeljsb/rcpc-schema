...
# Slot: coordinate_reach_y 


_How far the manipulator reaches along the robot's y-axis, recommended in metres._
...
URI: [rcpc:coordinate_reach_y](https://rcpc.for5672/schema/coordinate_reach_y)
...
| ---  | ---  |
| self | rcpc:coordinate_reach_y |
| native | rcpc:coordinate_reach_y |
