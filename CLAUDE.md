...
- Process module sources: `docs/research/pddl-for-process.md` (HDDL, HDDL 2.1, PDDL 2.1; the deciding source, with the subtask experiment), `docs/research/ma-pddl-for-process.md`, `docs/ideas/robot-entry-as-type.md` for additional PDDL background, task parameter kinds `docs/research/parameter-kinds-mapping.md`.
