...
|---|---|---|
| A process name collides case-insensitively with an imported one in the generated docs; Windows hides it, Linux CI fails the drift test | High if it happens: CI red on the commit | The name scan in Tasks 3, 4, and 5; the current names were scanned on 2026-09-18 and are clear, and `Material` against `made_of`, and the enum `MaterialCategory` against `category`, on 2026-09-21 |
